cd /d D:\RT-ThreadStudio\workspace\FangBaoGui
set RTT_ROOT=
set ENV_ROOT=D:/RT-ThreadStudio/platform/env_released/env
set RTT_EXEC_PATH=D:/RT-ThreadStudio/repo/Extract/ToolChain_Support_Packages/ARM/GNU_Tools_for_ARM_Embedded_Processors/10.2.1/bin
